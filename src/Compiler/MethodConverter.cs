...
public class MethodConverter{
    ...
    private IdentifierExpression DefineExpression(Z3Expr z3Expr) {
        ...
        var variableDef = AssignVariableIdentifier(dafnyExpr, dafnyType);
    ...
    private VariableDefinition AssignVariableIdentifier(SDC.AST.Expression e, SDC.AST.TypeReference typeReference){
